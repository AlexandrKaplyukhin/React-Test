...
let store = {
    _state: {
        profilePage: {
            posts: [{id: 0, message: 'Hello', like: '15'}, {id: 1, message: 'Alex team', like: '20'}, {
                id: 0,
                message: 'Hello',
                like: '15'
            }, {id: 1, message: 'Alex team', like: '20'}, {id: 0, message: 'Hello', like: '15'}, {
                id: 1,
                message: 'Alex team',
                like: '20'
    ...
    /* addPost() {
     ...
     sendMessage() {
         let newMessage = {
             id: 1, message: this._state.dialogsPage.newMessageText
         }
